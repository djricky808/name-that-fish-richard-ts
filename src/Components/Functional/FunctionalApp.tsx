...
export function FunctionalApp() {
  ...
  const [guessedFish, setGuessedFish] = useState('');
  ...
  return (
    <>
      ...
      <FunctionalGameBoard
        ...
        handleNamedFish={(namedFish) => {
          setGuessedFish(namedFish);
        }}
        checkAnswer= {checkAnswer}
        answers= {answers}
      />
      {answers.length === 0 && <FunctionalFinalScore correctCount={correctCount} />}
    </>
  );
}
